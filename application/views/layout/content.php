                            ...
                            <!--<div class="row align-items-center">
                                 <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active">Selamat Datang di Sistem Informasi Manajemen Rumah Sakit</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Jurnal Masuk</h5>
                                            <h4 class="fw-medium font-size-24"><?php echo $totaljurnalmasuk['jumlah']; ?> <i
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <p class="text-white-50 mb-0 mt-1">Selengkapnya</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Jurnal Keluar</h5>
                                            <h4 class="fw-medium font-size-24"><?php echo $totaljurnalkeluar['jumlah']; ?> <i
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Laporan Debit</h5>
                                            <h4 class="fw-medium font-size-16"><?php echo "Rp " . number_format($lapdebit['jumlah'], 2, ",", "."); ?> <i
                                                    class="mdi mdi-arrow-up text-success ms-2"></i></h4>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Laporan Kredit</h5>
                                            <h4 class="fw-medium font-size-16"><?php echo "Rp " . number_format($lapkredit['jumlah'], 2, ",", "."); ?> <i
                                                    class="mdi mdi-arrow-up text-success ms-2"></i></h4>
