                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left">
                                                        <?php
                                                            $kwitansi = $this->db->query("SELECT * FROM dt_suratjalan_customer WHERE datakwitansi_id = '".$u['datakwitansi_id']."';");
                                                            $kwitansi = $kwitansi->num_rows();
                                                            // echo $kwitansi;
                                                            if($u["status"] == "N"){
                                                                ?>
                                                                    <a href="<?= base_url('data_kwitansi/validasi_y/' . $u['datakwitansi_id']) ?>" class="btn btn-success btn-sm" style="width:35px;"><i class="fa fa-check"></i></a>                                                     
                                                                    <?php
                                                            }elseif($u["status"] == "Y" && $kwitansi == 0){
                                                                ?>
                                                                    <!-- <a href="<?= base_url('data_kwitansi/validasi_n/' . $u['datakwitansi_id']) ?>" class="btn btn-danger btn-sm" style="width:35px;"><i class="fas fa-times"></i></a>                                                      -->
                                                                    <?php
                                                            }
                                                            ?>
                                                        
                                                        <a href="<?= base_url('data_kwitansi/ubah/' . $u['datakwitansi_id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>                                                     
                                                        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('data_kwitansi/hapus/' . $u['datakwitansi_id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
