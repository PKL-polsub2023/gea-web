                                ...
                                <div class="card mini-stat bg-dark text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Data Kwitansi</h5>
                                            <h4 class="fw-medium font-size-24"><?php echo "10" ?> <i
                                ...
                                <div class="card mini-stat bg-dark text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Surat Jalan Supplier</h5>
                                            <h4 class="fw-medium font-size-24"><?php echo "10"; ?> <i
                                ...
                                <div class="card mini-stat bg-dark text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Surat Jalan Customer</h5>
                                            <h4 class="fw-medium font-size-16"><?php echo "10"; ?> <i
                                                    class="mdi mdi-arrow-up text-success ms-2"></i></h4>
