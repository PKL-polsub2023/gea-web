...
<!-- ============================================================== -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Laporan Profit Lost</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Laporan Profit Lost</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
    ...
    <script>
        ...
        function getData(fromDate, toDate) {
            let url = "<?= site_url('laporan_profit_lost/labarugi_view') ?>"
        ...
        document.getElementById("cetak").onclick = function() {
            ...
            if (fromDate === '' || toDate === '') {
                ...
                const href = '<?= site_url('laporan_profit_lost/labarugi_pdf/') ?>' + fromDate + '/' + toDate
