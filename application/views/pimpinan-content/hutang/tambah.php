                                                ...
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="tekananawal" type="number" min="0" class="form-control input-mask" >
                                                                                                               
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Tekanan Akhir</label>
                                                            <input id="input-mask" name="tekananakhir" type="number" min="0" class="form-control input-mask" >
                                                                                                        
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Volume Berangkat</label>
                                                            <input id="input-mask" name="volumeberangkat" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Preasure Keluar (P)</label>
                                                            <input id="input-mask" name="preasure" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Meter Awal (V1)</label>
                                                            <input id="input-mask" name="meterawal" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Meter Akhir (V2)</label>
                                                            <input id="input-mask" name="meterakhir" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">BBM</label>
                                                            <input id="input-mask" name="bbm" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Ritase</label>
                                                            <input id="input-mask" name="ritase" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Total (Rp)</label>
                                                            <input id="input-mask" name="total" type="number" min="0" class="form-control input-mask" >                                                            
                                                        </div>
                                                    </div>
                                                </div>
