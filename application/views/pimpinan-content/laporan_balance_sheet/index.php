...
<!-- ============================================================== -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Laporan Balance Sheet</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Laporan Balance Sheet</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
    ...
    <script>
        ...
        function getData(fromDate, toDate) {
            let url = "<?= site_url('laporan_balance_sheet/neraca_view') ?>"
        ...
        document.getElementById("cetak").onclick = function() {
            ...
            if (fromDate === '' || toDate === '') {
                ...
                const href = '<?= site_url('laporan_balance_sheet/neraca_pdf/') ?>' + fromDate + '/' + toDate
