                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo base_url('master_customer/simpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="alamat" class="form-control input-mask">                                                            
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Nama PIC</label>
                                                            <input id="input-mask" name="namapic" class="form-control input-mask">                                                            
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">No Telp</label>
                                                            <input id="input-mask" name="notelp" class="form-control input-mask">                                                            
                                                        </div>   
