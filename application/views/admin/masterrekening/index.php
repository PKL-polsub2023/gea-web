                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-md-block">
                                        <div class="dropdown">                                                                
                                            ...
                                            <a class="btn btn-primary" href="<?php echo base_url()?>master_rekening/tambah" role="button">Tambah Master rekening</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        <a href="<?= base_url('master_rekening/ubah/' . $u['masterrekening_id']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>                                                     
                                                        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('master_rekening/hapus/' . $u['masterrekening_id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
