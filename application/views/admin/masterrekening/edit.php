                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Form Edit Master Rekening</h4>
                                        <form action="<?php echo base_url('master_rekening/ubahsimpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Nama Rekening</label>
                                                            <input id="input-mask" name="namarekening" value="<?= $edit['namarekening'];?>" class="form-control input-mask">                                                            
                                                        </div>


                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Atas Nama</label>
                                                            <input id="input-mask" name="atasnama" value="<?= $edit['atasnama'];?>" class="form-control input-mask">                                                            
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">No Rekening</label>
                                                            <input id="input-mask" name="norekening" value="<?= $edit['norekening'];?>" class="form-control input-mask">                                                            
                                                        </div>   
                                            ...
                                            <div class="col-md-2">
                                                <div class="float-end d-none d-md-block">
                                                    <div class="dropdown">  
                                                        <input name="masterrekening_id" value="<?= $edit['masterrekening_id'];?>" type="hidden">
