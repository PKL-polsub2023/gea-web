                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Jurnal Harian Balik</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Jurnal Harian Balik</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                                    <div class="float-end d-md-block">
                                        <div class="dropdown">                                                                
                                            ...
                                            <a class="btn btn-primary" href="<?php echo base_url()?>jurnal_balik/tambah" role="button">Tambah Jurnal Balik</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%;text-align:center">
                                                        ...
                                                        <a href="<?= base_url('jurnal_balik/detail/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                        <a href="<?= base_url('jurnal_balik/edit/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
												        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('jurnal_balik/hapus/' . $u['no_jurnal']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
