          ...
          <div class="main-content">
              ...
              <div class="page-content">
                  <div class="container-fluid">
                    ...
                    <div id="content" data-url="<?= base_url('jurnal_balik') ?>">
                    <!-- Untuk keperluan script dibawah -->
                          ...
                          <div class="row align-items-center">
                              <div class="col-md-8">
                                  ...
                                  <ol class="breadcrumb m-0">
                                      ...
                                      <li class="breadcrumb-item"><a href="#">Jurnal Balik</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Data Jurnal Balik</li>
                                  </ol>
                              </div>
                              <div class="col-md-4">
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="card">
                                  <div class="card-body">
                                      <h4 class="card-title mb-4">Form Jurnal Harian Balik</h4>
                                      
                                      <form action="<?php echo base_url('jurnal_balik/proses_tambah');?>" method="POST" enctype="multipart/form-data"> 
...
<script type="text/javascript">
    const url_getakun = "<?= site_url('jurnal_balik/getakun') ?>";
