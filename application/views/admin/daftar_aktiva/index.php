                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%;text-align:center">
                                                        ...
                                                        <a href="<?= base_url('daftar_aktiva/detail/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                        <a href="<?= base_url('daftar_aktiva/edit/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
												        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('daftar_aktiva/hapus/' . $u['no_jurnal']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
