    ...
    <div>
        ...
        <table class="zz">
            ...
            <tr>
                ...
                <?php echo "Tagihan " . $u['namaperusahaan'] . "<br>" . $fromdate . " - " .$todate; ?>
                </td>
                <td class="data2" style="width:10%"><?php echo $volume ?></td>
                <td class="data2" style="width:10%"><?php echo number_format($u['harga_jual'], 0, ',', '.') ?></td>
