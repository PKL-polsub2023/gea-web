                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Form Tambah Master Supplier</h4>
                                        <form action="<?php echo base_url('master_supplier/simpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="namaspbg" class="form-control input-mask">                                                            
                                                        </div>


                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Lokasi Supplier</label>
                                                            <input id="input-mask" name="lokasispbg" class="form-control input-mask">                                                            
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Jarak Supplier (KM)</label>
                                                            <input id="input-mask" name="jarakspbg" class="form-control input-mask" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" min="0">                                                            
                                                        </div>
                                                        
                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Harga Satuan</label>
                                                            <input id="input-mask" name="hargasatuan" class="form-control input-mask" type="number" min="0">                                                            
                                                        </div>
