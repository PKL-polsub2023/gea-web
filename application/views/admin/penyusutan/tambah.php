          ...
          <div class="main-content">
              ...
              <div class="page-content">
                  <div class="container-fluid">
                    ...
                    <div id="content" data-url="<?= base_url('penyusutan') ?>">
                    <!-- Untuk keperluan script dibawah -->
                          ...
                          <div class="row align-items-center">
                              <div class="col-md-8">
                                  ...
                                  <ol class="breadcrumb m-0">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Data Penyusutan</li>
                                  </ol>
                              </div>
                              <div class="col-md-4">
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="card">
                                  <div class="card-body">
                                      <h4 class="card-title mb-4">Form Penyusutan</h4>
                                      
                                      <form action="<?php echo base_url('penyusutan/proses_tambah');?>" method="POST" enctype="multipart/form-data"> 
        ...
        $(document).ready(function(){
            ...
            $('#mastercoa_id').change(function(){ 
                ...
                if($(this).val() == '') reset()
                            ...
                            var id=$(this).val();
                            $.ajax({
                                url : "<?php echo site_url('penyusutan/getakun');?>",
                                method : "POST",
                                data : {id: id},
                                async : true,
                                dataType : 'json',
            ...
            $(document).on('click', '#tambah', function(e){
				...
				const data_jurnalmasuk= {
					...
					debit: $('input[name="debit"]').val() == "" ? 0 : $('input[name="debit"]').val(),
					kredit: $('input[name="kredit"]').val() == "" ? 0 : $('input[name="kredit"]').val(),
				...
				// } else {
					$.ajax({
						...
						success: function(data){
                            ...
                            $('#totaldebit').html('<p align="left">Total Debit : <strong>' + formatRupiah(hitung_totaldebit(), "Rp. ") + '</strong></p>')
                            $('input[name="totaldebit_hidden"]').val(hitung_totaldebit())

							$('#totalkredit').html('<p align="left">Total Kredit : <strong>' + formatRupiah(hitung_totalkredit(), "Rp. ") + '</strong></p>')
			...
			function hitung_totalkredit(){
				...
				$('input[name="kredit_hidden[]"]').each(function(){
                    var nilai = $(this).val() == NaN || $(this).val() == '' ? 0 : parseInt($(this).val().split('.').join(""));
					totalkredit += parseInt(nilai)
				})
