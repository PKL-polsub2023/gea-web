                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('penyusutan/update/' . $jurnal->penyusutan_id) ?>" method="POST" enctype="multipart/form-data"> 
                                <input type="hidden" name="id" value="<?= $jurnal->penyusutan_id ?>" />
...
<script type="text/javascript">
    const url_getakun = "<?= site_url('penyusutan/getakun') ?>";
</script>
