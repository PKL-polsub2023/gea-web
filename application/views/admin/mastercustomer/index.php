                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-md-block">
                                        <div class="dropdown">                                                                
                                            ...
                                            <a class="btn btn-primary" href="<?php echo base_url()?>master_customer/tambah" role="button">Tambah Master Customer</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        ...
                                                        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('master_customer/hapus/' . $u['mastercustomer_id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
