...
<!-- ============================================================== -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Laporan Trial Balance</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Laporan Trial Balance</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
    ...
    <script>
        ...
        function getData(fromDate, toDate) {
            let url = "<?= site_url('laporan_trial_balance/neracasaldo_view') ?>"
        ...
        document.getElementById("cetak").onclick = function() {
            ...
            if (fromDate === '' || toDate === '') {
                ...
                const href = '<?= site_url('laporan_trial_balance/neracasaldo_pdf/') ?>' + fromDate + '/' + toDate
