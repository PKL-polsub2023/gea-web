                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Form Tambah Master Kendaraan</h4>
                                        <form action="<?php echo base_url('master_kendaraan/simpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="ts" class="form-control input-mask">                                                            
                                                        </div>


                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Plat no</label>
                                                            <input id="input-mask" name="plat_no" class="form-control input-mask">                                                            
                                                        </div>   
