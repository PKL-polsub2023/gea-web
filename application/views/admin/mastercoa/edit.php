                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Form Edit Master COA</h4>
                                        <form action="<?php echo base_url('master_coa/ubahsimpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="kode" value="<?= $edit['kode'];?>" class="form-control input-mask">                                                            
                                                        </div>


                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Nama Akun</label>
                                                            <input id="input-mask" name="nama" value="<?= $edit['nama'];?>" class="form-control input-mask">                                                            
                                                        </div>    
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <select name="id_kelompokakun" id="id_kelompokakun" class="form-control" required>
                                                                <?php foreach ($datakelompokakun as $u): ?>
                                                                        <?php
                                                                        $selected = "";
                                                                        if($edit['id_kelompokakun'] == $u['id_kelompokakun']){
                                                                            $selected = "selected";
                                                                        }
                                                                        ?>
                                                                        <option <?= $selected; ?> value="<?= $u['id_kelompokakun'] ?>"><?= $u['nama'] ?></option>
                                                                    <?php endforeach ?>
                                                            </select> 
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <?php
                                                                ...
                                                                echo form_dropdown('parent_id', $dropdownCOA, $edit['parent_id'], 'class="form-control input-mask" ');
                                                            ?>                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Bank</label>
                                                            <input id="input-mask" name="bank" value="<?= $edit['bank'];?>" class="form-control input-mask" required>                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">No Rekening</label>
                                                            <input id="input-mask" name="norekening" value="<?= $edit['norekening'];?>" class="form-control input-mask" required>                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Atas Nama</label>
                                                            <input id="input-mask" name="atasnama" value="<?= $edit['atasnama'];?>" class="form-control input-mask" required>                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="float-end d-none d-md-block">
                                                    <div class="dropdown">  
                                                        <input name="mastercoa_id" value="<?= $edit['mastercoa_id'];?>" type="hidden">
