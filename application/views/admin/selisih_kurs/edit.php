                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('selisih_kurs/update/' . $jurnal->selisihkurs_id) ?>" method="POST" enctype="multipart/form-data"> 
                                <input type="hidden" name="id" value="<?= $jurnal->selisihkurs_id ?>" />
