                                ...
                                <div class="col-md-4">
                                    <div class="float-end  d-md-block">
                                        <div class="dropdown">                                                                
                                            ...
                                            <a class="btn btn-primary" href="<?php echo base_url()?>selisih_kurs/tambah" role="button">Tambah Selisih Kurs</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%;text-align:center">
                                                        ...
                                                        <a href="<?= base_url('selisih_kurs/detail/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                        <a href="<?= base_url('selisih_kurs/edit/' . $u['no_jurnal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
												        <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('selisih_kurs/hapus/' . $u['no_jurnal']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
