...
class Jurnal_Balik_Model extends CI_Model{
    ...
    public function Lihatjurnalbalik(){	

		$query = $this->db->query("SELECT * FROM dt_jurnal_balik");
	...
	public function lihat_detail_jurnal($no_jurnal){	
		...
		$query = $this->db->query("SELECT * FROM dt_jurnal_balik a, dt_jurnal_balik_detail b where a.no_jurnal=b.no_jurnal and b.no_jurnal='$no_jurnal'");

		return $query->result_array();

	}
	public function lihat_no_jurnal($no_jurnal){
		return $this->db->get_where('dt_jurnal_balik', ['no_jurnal' => $no_jurnal])->row();
	}

	
	public function hapusjurnal($no_jurnal){
		return $this->db->delete('dt_jurnal_balik', ['no_jurnal' => $no_jurnal]);
	}


    public function hapusprogres($id)
    {
        $this->db->where('dt_jurnal_balik_id',$id);
    ...
    {
        $this->db->where('dt_jurnal_balik_id',$id); 
        return $this->db->delete('dt_jurnal_balik');
	...
	public function tambah($data){
		return $this->db->insert('dt_jurnal_balik', $data);
	}
