...
class Daftar_Aktiva_Model extends CI_Model{
    ...
    public function lihatdaftaraktiva(){	

		$query = $this->db->query("SELECT * FROM dt_daftar_aktiva");
	...
	public function lihat_detail_daftar_aktiva($no_jurnal){	

		$query = $this->db->query("SELECT * FROM dt_daftar_aktiva a, dt_daftar_aktiva_detail b where a.no_jurnal=b.no_jurnal and b.no_jurnal='$no_jurnal'");

		return $query->result_array();

	}
	public function lihat_no_jurnal($no_jurnal){
		return $this->db->get_where('dt_daftar_aktiva', ['no_jurnal' => $no_jurnal])->row();
	}

	
	public function hapusjurnal($no_jurnal){
		return $this->db->delete('dt_daftar_aktiva', ['no_jurnal' => $no_jurnal]);
	}


    public function hapusprogres($id)
    {
        $this->db->where('dt_daftar_aktiva_id',$id);
    ...
    {
        $this->db->where('dt_daftar_aktiva_id',$id); 
        return $this->db->delete('dt_daftar_aktiva');
	...
	public function tambah($data){
		return $this->db->insert('dt_daftar_aktiva', $data);
	}
