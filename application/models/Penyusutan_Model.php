...
class Penyusutan_Model extends CI_Model{
    ...
    public function lihatpenyusutan(){	

		$query = $this->db->query("SELECT * FROM dt_penyusutan");
	...
	public function lihat_detail_penyusutan($no_jurnal){	

		$query = $this->db->query("SELECT * FROM dt_penyusutan a, dt_penyusutan_detail b where a.no_jurnal=b.no_jurnal and b.no_jurnal='$no_jurnal'");

		return $query->result_array();

	}
	public function lihat_no_jurnal($no_jurnal){
		return $this->db->get_where('dt_penyusutan', ['no_jurnal' => $no_jurnal])->row();
	}

	
	public function hapusjurnal($no_jurnal){
		return $this->db->delete('dt_penyusutan', ['no_jurnal' => $no_jurnal]);
	}


    public function hapusprogres($id)
    {
        $this->db->where('dt_penyusutan_id',$id);
    ...
    {
        $this->db->where('dt_penyusutan_id',$id); 
        return $this->db->delete('dt_penyusutan');
	...
	public function tambah($data){
		return $this->db->insert('dt_penyusutan', $data);
	}
