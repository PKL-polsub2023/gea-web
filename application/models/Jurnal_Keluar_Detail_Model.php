...
class Jurnal_Keluar_Detail_Model extends CI_Model {
	protected $_table = 'dt_jurnal_masuk_detail';
	...
	public function hapusjurnaldetail($no_jurnal){
		return $this->db->delete('dt_jurnal_masuk_detail', ['no_jurnal' => $no_jurnal]);
	}
